			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="id_keyboard" placeholder="Masukkan ID Keyboard" maxlength="5">
					</div>
					<div class="form-group">
						<label for="nama_keyboard">Keyboard</label>
						<input type="text" class="form-control" id="nama_keyboard" placeholder="Masukkan Nama Keyboard" maxlength="50">
					</div>
					<div class="form-group">
	...
	<script>
		...
		$('#simpan').on('click', function () {
			...
			if ($('#nama_keyboard').val() == '') {
				alert('Nama Keyboard belum diisi');
				$('#nama_keyboard').focus();
				return;
			}
